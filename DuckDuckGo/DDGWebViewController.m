...
-(void)searchControllerActionButtonPressed
{
    ...
    if(query)
    {
        ...
        shareURL = [NSURL URLWithString:[@"https://bttf.duckduckgo.com/?q=" stringByAppendingString:escapedQuery]];
    }
...
-(void)loadQueryOrURL:(NSString *)queryOrURLString
{
    ...
    {
        // direct query
        urlString = [NSString stringWithFormat:@"https://bttf.duckduckgo.com/?q=%@&ko=-1&kl=%@",
