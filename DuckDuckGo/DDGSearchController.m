...
- (IBAction)actionButtonPressed:(id)sender {
    ...
    _wePopoverController.containerViewProperties = [self improvedContainerViewProperties];
    
    CGRect popoverRect = _actionButton.frame;
    popoverRect.origin.x -= 35; // correction for what is apparently a bug in WEPopover
    [_wePopoverController presentPopoverFromRect:popoverRect
                                          inView:self.view
